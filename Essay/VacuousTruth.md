...
- 증명론적 해석 : 유클리드 기하학은 공리(전제)로 부터 풍부한 명제들을 증명할 수 있다. 다양한 양상을 증명할 수 있는 논리 체계를 갖추는 것이 중요하며, 무언가를 증명하기에 부실한 체계를 가지고 있다면 증명론적 해석을 위한 가치가 떨어지는 체계를 가진 것으로 풍부한 대상을 증명할 수 있는 체계 속에서의 논리 전개가 중요하다.
